...
process featureCounts {
    ...
    if (params.singleEnd) {
        """
        featureCounts -t exon -a $gtf -Q 10 -g gene_id -o ${bam_featurecounts.baseName}_gene.featureCounts.txt -s $featureCounts_direction $bam_featurecounts
        featureCounts -t exon -a $gtf -Q 10 -g gene_biotype -o ${bam_featurecounts.baseName}_biotype.featureCounts.txt -s $featureCounts_direction $bam_featurecounts
